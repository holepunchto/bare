...
| :-------- | :----------- | :----------------------------------- | :----- | :-------------------------- |
| GNU/Linux | `arm64`      | >= Linux 5.15, >= GNU C Library 2.35 | Tier 1 | Ubuntu 22.04, OpenWrt 23.05 |
| GNU/Linux | `x64`        | >= Linux 5.15, >= GNU C Library 2.35 | Tier 1 | Ubuntu 22.04, OpenWrt 23.05 |
| GNU/Linux | `arm64`      | >= Linux 5.10, >= musl 1.2           | Tier 2 | Alpine 3.13, OpenWrt 22.03  |
| GNU/Linux | `x64`        | >= Linux 5.10, >= musl 1.2           | Tier 2 | Alpine 3.13, OpenWrt 22.03  |
| GNU/Linux | `mips`       | >= Linux 5.10, >= musl 1.2           | Tier 2 | OpenWrt 22.03               |
| GNU/Linux | `mipsel`     | >= Linux 5.10, >= musl 1.2           | Tier 2 | OpenWrt 22.03               |
| Android   | `arm`        | >= 9                                 | Tier 1 |
| Android   | `arm64`      | >= 9                                 | Tier 1 |
| Android   | `ia32`       | >= 9                                 | Tier 1 |
| Android   | `x64`        | >= 9                                 | Tier 1 |
| macOS     | `arm64`      | >= 11.0                              | Tier 1 |
| macOS     | `x64`        | >= 11.0                              | Tier 1 |
| iOS       | `arm64`      | >= 14.0                              | Tier 1 |
| iOS       | `x64`        | >= 14.0                              | Tier 1 | Simulator only              |
| Windows   | `arm64`      | >= Windows 11                        | Tier 1 |
| Windows   | `x64`        | >= Windows 10                        | Tier 1 |
