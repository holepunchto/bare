...
pear.onuncaughtexception = function (err) {
...
pear.onunhandledrejection = function (reason, promise) {
...
process.addon = function addon (dirname, opts) {
  ...
  return pear.loadAddon(dirname, (((opts && opts.static) || !process.bootstrapped) ? pear.ADDONS_STATIC : pear.ADDONS_DYNAMIC) | (resolve ? pear.ADDONS_RESOLVE : 0))
}
